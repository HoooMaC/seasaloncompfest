...
const GalleryItem = ({ image, title, description }: ImageProps) => {
  return (
    <div className='col-span-1 flex w-full flex-col items-center justify-center'>
      <div className='group relative aspect-square w-[375px] cursor-none overflow-hidden rounded-xl bg-primary-100 2xl:w-[400px]'>
        <Image
          src={image}
          alt={description}
          width={400}
          height={400}
          className={`h-full w-full object-cover group-hover:opacity-30`}
        />
        <div
